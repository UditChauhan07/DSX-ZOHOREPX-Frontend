...
const handleclick = () =>{
...

            {
                ...
                (
                  ...
                  (
                    <>
                    <div
                style={{ textAlign: "end", marginBottom: "2%", marginTop: "-5%",marginRight:"1%"}}
              >
              ...
              <div className="container task-div mt-3">
                ...
                {openTasks.map((task, index) => (
                  <div className="listdivv mt-3" key={index}>
                    ...
                    <p className=" tasklist-name"><PiListDashes className="taskicon" /> {task.tasklist.name}</p>
                    <hr />
                  </div>
                ))}
              </div>
              ...
              <div className="container task-div mt-3">
                <div className="d-flex text-task">
                  <button type="button" className="btn btn- progress-btn mt-2">
              ...
              <div className="container task-div mt-3">
                <div className="d-flex text-task">
                  <button type="button" className="btn btn- Tested-btn mt-2">
                    To be Tested({testedTasks.length})
                  </button>
                  <button type="button" className="btn btn- arrow2-btn mt-2">
                    <LuArrowLeftFromLine />{" "}
                  </button>
                </div>
  ...
  <p className="task-key">{task.key}</p>
              ...
              <div className="container task-div mt-3">
                <div className="d-flex text-task">
                  <button type="button" className="btn btn- review-btn mt-2">
                    In Review({reviewTasks.length})
                  </button>
                  <button type="button" className="btn btn- arrow3-btn mt-2">
                    <LuArrowLeftFromLine />{" "}
                  </button>
                </div>
  ...
  <p className="task-key">{task.key}</p>
              ...
              <div className="container task-div mt-3">
                <div className="d-flex text-task">
                  <button type="button" className="btn btn- closed-btn mt-2">
                    Closed({closedTasks.length})
                  </button>
                  <button type="button" className="btn btn- arrow4-btn mt-2">
                    <LuArrowLeftFromLine />{" "}
                  </button>
                </div>
              ...
              <div className="container task-div mt-3">
                <div className="d-flex text-task">
                  ...
                  <button type="button" className="btn btn- arrow5-btn mt-2">
                    <LuArrowLeftFromLine />{" "}
                  </button>
                </div>
